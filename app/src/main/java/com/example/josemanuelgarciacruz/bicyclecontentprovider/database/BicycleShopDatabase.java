package com.example.josemanuelgarciacruz.bicyclecontentprovider.database;
...
//import com.example.josemanuelgarciacruz.bicyclecontentprovider.bicycle.database.BicycleContract;
...
public class BicycleShopDatabase extends SQLiteOpenHelper {
    ...
    public void initiliceData(SQLiteDatabase db){
